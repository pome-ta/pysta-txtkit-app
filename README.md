...
# 📝 2020/01/08
再開、基礎(色々なtutorial)をやる


- `returnKeyType=` で、色々な決定でた
- また、コードのクラスとかの書き方で悩む
	- Python の基礎なのか、objc のコードを見て知るのか
	- 同じところで躓きそう 😭
- 動的な処理をする考え方 🙅‍♂️
	- 素人なんだから、まずはView するだけ
	- LSP 連携もその時にさらいたい
- いいtutorial が見つかんない 🤗
...
まずは、リファクタリングして、文字数や行数取得と、キャレット位置把握に挑戦

`create_objc_class()` を理解せねばな、、、


あと、class と関数のそのものを理解してないのでちゃんとしないとな、、、
